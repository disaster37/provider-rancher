...
func (tr *EtcdBackup) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"backup_config[*].s3_backup_config[*].access_key": "backupConfig[*].s3BackupConfig[*].accessKeySecretRef", "backup_config[*].s3_backup_config[*].secret_key": "backupConfig[*].s3BackupConfig[*].secretKeySecretRef"}
}

// GetObservation of this EtcdBackup
func (tr *EtcdBackup) GetObservation() (map[string]any, error) {
...
func (tr *EtcdBackup) SetObservation(obs map[string]any) error {
...
func (tr *EtcdBackup) GetParameters() (map[string]any, error) {
...
func (tr *EtcdBackup) SetParameters(params map[string]any) error {
...
// GetInitParameters of this EtcdBackup
func (tr *EtcdBackup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EtcdBackup
func (tr *EtcdBackup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
