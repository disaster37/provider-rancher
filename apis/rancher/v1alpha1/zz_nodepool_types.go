...
type NodePoolInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/disaster37/provider-rancher/apis/rancher/v1alpha1.NodeTemplate
	NodeTemplateID *string `json:"nodeTemplateId,omitempty" tf:"node_template_id,omitempty"`

	// Reference to a NodeTemplate in rancher to populate nodeTemplateId.
	// +kubebuilder:validation:Optional
	NodeTemplateIDRef *v1.Reference `json:"nodeTemplateIdRef,omitempty" tf:"-"`

	// Selector for a NodeTemplate in rancher to populate nodeTemplateId.
	// +kubebuilder:validation:Optional
	NodeTemplateIDSelector *v1.Selector `json:"nodeTemplateIdSelector,omitempty" tf:"-"`
