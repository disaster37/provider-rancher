...
// ClusterV2 is the Schema for the ClusterV2s API. |Provides a Rancher v2 Cluster v2 resource. This can be used to create RKE2 and K3s Clusters for Rancher v2 environments and retrieve their information.
