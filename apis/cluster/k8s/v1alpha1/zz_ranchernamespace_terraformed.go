...
func (tr *RancherNamespace) GetObservation() (map[string]any, error) {
...
func (tr *RancherNamespace) SetObservation(obs map[string]any) error {
...
func (tr *RancherNamespace) GetParameters() (map[string]any, error) {
...
func (tr *RancherNamespace) SetParameters(params map[string]any) error {
...
// GetInitParameters of this RancherNamespace
func (tr *RancherNamespace) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RancherNamespace
func (tr *RancherNamespace) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
