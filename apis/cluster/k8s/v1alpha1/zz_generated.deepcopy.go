...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RancherNamespaceInitParameters) DeepCopyInto(out *RancherNamespaceInitParameters) {
	*out = *in
	if in.Annotations != nil {
		in, out := &in.Annotations, &out.Annotations
		*out = make(map[string]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RancherNamespaceInitParameters.
func (in *RancherNamespaceInitParameters) DeepCopy() *RancherNamespaceInitParameters {
	if in == nil {
		return nil
	}
	out := new(RancherNamespaceInitParameters)
	in.DeepCopyInto(out)
	return out
}
