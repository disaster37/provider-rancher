...
type RancherNamespaceInitParameters struct {
...
type RancherNamespaceSpec struct {
	...
	// autoscaler.
	InitProvider RancherNamespaceInitParameters `json:"initProvider,omitempty"`
}
...
// RancherNamespace is the Schema for the RancherNamespaces API. |Provides a Rancher v2 Namespace resource. This can be used to create namespaces for Rancher v2 environments and retrieve their information.
